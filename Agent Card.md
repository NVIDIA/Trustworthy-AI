...
* [OpenClaw] <br>
* [Hermes] <br>
* [Insert Agent Name Not Listed Above] <br>
...
[Provide list of reference(s), link(s) to the publication/paper/article, associated works, and other technical documentation where relevant.  Links to model cards underpinning the agent go here.]  <br> 
...
[Describe data speed, e.g. real time provisioning, near time provisioning, batch data, etc.] <br>
...
**Hardware Specific Requirements [Specify by Tool]:** <br>
[Insert compute performance, memory bandwidth, or thermal power needed here] <br>

## Agent Version(s): <br> 
[Use unique identifier for identifying the agent in the future- this may be part of our internal naming, specifying variation like "pruned," "unpruned," "trained," or "deployable" or "quantized" where necessary and including a versioning number like vX.X along with short description differentiating if multiple versions are available]  <br>
...
**Database Name:** [Insert Name Here] <br>
**Database Type** <br>
**[ ] Commercial** <br>
**[ ] Confidential** <br>
**[ ] Internal** <br>
