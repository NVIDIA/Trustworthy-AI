...
"""Pydantic models for the Pose SuperAnnotate Format Converter."""
...
class PoseSAConverterConfig(BaseModel):
    """Configuration for the Pose SuperAnnotate Format Converter."""
...
class PoseSAConversionResult(BaseModel):
    """Result of a single pose landmark file conversion."""
