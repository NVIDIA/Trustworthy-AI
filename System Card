...
## Description: <br> 
[Describe what this system does in one sentence, including supporting image/video and/or reference blog/article as available.  For instance, _______ [insert name of system] _______ [insert verb] _______.] <br>

[This system is ready for commercial or non-commercial use.] OR [This system is for research and development only.] OR [This system is for demonstration purposes and not for production usage.]  <br>

## Third-Party Community Consideration [(Insert for Third-Party Community Systems)] <br>
This system is not owned or developed by [insert name of company]. This system has been developed and built to a third-party’s requirements for this application and use case; see link to (Insert Name and Link) Model Card.
...
**Operational Restrictions (e.g., Use case restrictions) <br>

** Data Ingestion Source:** [Describe data speed, e.g. real time provisioning, near time provisioning, batch data, etc.] <br>
** Data Ingestion Preparation Techniques:** [Describe any data sanitization or enrichment techniques used] <br>
